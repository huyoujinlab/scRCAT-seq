...
df <- data.frame(V1=c(1,2,3,4,5,6,7),
                 V2=c(nrow(hm_5cap_new[hm_5cap_new[,1]<0.1 & hm_5cap_new[,1]>-0.12,]),
                      ...
                      nrow(hm_5cap_new[hm_5cap_new[,7]<0.1 & hm_5cap_new[,7]>-0.12,])))
...
df <- data.frame(V1=c(1,2,3,4,5,6,7),
                 V2=c(nrow(hm_3tail_new[hm_3tail_new[,1]<0.1 & hm_3tail_new[,1]>-0.12,]),
                      ...
                      nrow(hm_3tail_new[hm_3tail_new[,7]<0.1 & hm_3tail_new[,7]>-0.12,])))
