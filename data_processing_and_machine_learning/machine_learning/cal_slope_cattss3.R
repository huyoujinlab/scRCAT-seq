######### the first args is output file generated by cal_slope_cattss2.R script
...
write.table(a[,c(2,3,4,1,6,5)],"temp.bed",quote = FALSE,row.names = FALSE,col.names = FALSE,sep = "\t")
